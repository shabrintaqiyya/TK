...
public class ResepController {
    ...
    // @GetMapping("/resep/viewall/{idAppoinment}/{idDokter}")
    // public String listResepAppointment(@RequestParam(value = "idAppoinment") String idAppoinment, @RequestParam(value = "idDokter") String idDokter, Model model){
    //     List<ResepModel> listResep = resepService.getListResep();

    //     List<ResepModel> temp = new ArrayList<ResepModel>();

    //     // System.out.println("IDDDDDD");

    //     for(ResepModel a: listResep){
    //         AppointmentModel app = a.getKodeAppointment();
    //         DokterModel dok = a.getKodeAppointment().getDokter();

    //         System.out.println("PRIINNTTT "+ app.getKode());

    //         if(app.getKode().equals(idAppoinment) && dok.getId().equals(idDokter)){
    //             temp.add(a);
    //         }
    //     }
    //     // ResepModel resep = resepService.getResepById(id);
    ...
    //     // log.info("User melihat detail resep");
    //     // return "";
    //     model.addAttribute("listResep", temp);
    //     log.info("User melihat list seluruh resep");
    //     return "viewall-resep";
    // }
